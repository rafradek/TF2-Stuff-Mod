...
public class WeaponLoopSound extends WeaponSound {
	...
	public WeaponLoopSound(SoundEvent p_i45104_1_,EntityLivingBase entity,boolean firing, WeaponData conf,boolean crit, int type) {
	...
	public void update() {
		...
		boolean playThis=(entity.getCapability(TF2weapons.WEAPONS_CAP, null).critTime>0&&crit)||(entity.getCapability(TF2weapons.WEAPONS_CAP, null).critTime<=0&&!crit);
