...
public class RenderJar extends Render<EntityJar> {
	...
	private static final ResourceLocation texture = new ResourceLocation(TF2weapons.MOD_ID,"textures/entity/projectile/jarate.png");
    ...
    GL11.glRotatef(((entity.prevRotationPitch + (entity.rotationPitch - entity.prevRotationPitch) * partialTick)*-1)+180, 1.0F, 0.0F, 0F);
