...
public class RenderRocket extends Render<EntityRocket> {
	...
	private static final ResourceLocation texture = new ResourceLocation(TF2weapons.MOD_ID,"textures/entity/projectile/rocket.png");
	...
	if(((EntityProjectileBase)entity).getCritical()==2){
        ...
        if(TF2weapons.getTeamForDisplay((EntityLivingBase) ((EntityProjectileBase)entity).shootingEntity)==0){
