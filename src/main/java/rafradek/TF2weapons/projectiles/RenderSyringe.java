...
public class RenderSyringe extends Render<EntitySyringe> {

	// if you want a model, be sure to add it here:
	private ModelBase model;
	private static final ResourceLocation texturered = new ResourceLocation(TF2weapons.MOD_ID,"textures/entity/projectile/syringered.png");
	private static final ResourceLocation textureblu = new ResourceLocation(TF2weapons.MOD_ID,"textures/entity/projectile/syringeblu.png");
	...
	@Override
	protected ResourceLocation getEntityTexture(EntitySyringe entity) {
		
		return TF2weapons.getTeamForDisplay(entity.shootingEntity)==0?texturered:textureblu;
	}

	@Override
	public void doRender(EntitySyringe entity, double x, double y, double z, float yaw, float partialTick) {
	GL11.glPushMatrix();
    ...
    GL11.glRotatef((entity.prevRotationPitch + (entity.rotationPitch - entity.prevRotationPitch) * partialTick)*-1, 1.0F, 0.0F, 0.0F);
