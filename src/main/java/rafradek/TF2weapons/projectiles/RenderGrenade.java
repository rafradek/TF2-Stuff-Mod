...
public class RenderGrenade extends Render<EntityGrenade> {
	...
	private static final ResourceLocation texturered = new ResourceLocation(TF2weapons.MOD_ID,"textures/entity/projectile/grenadered.png");
	private static final ResourceLocation textureblu = new ResourceLocation(TF2weapons.MOD_ID,"textures/entity/projectile/grenadeblu.png");
