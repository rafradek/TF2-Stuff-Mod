...
public class MannCoBuilding extends Village{
    ...
    public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
    {
        ...
        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 1, 0, 13, 16, 10, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 0, 2, 13, 15, 10, stone, Blocks.AIR.getDefaultState(), false);
        ...
        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 2, 3, 0, 3, 9, Blocks.GLASS_PANE.getDefaultState(), Blocks.GLASS_PANE.getDefaultState(), false);
        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 13, 2, 3, 13, 3, 9, Blocks.GLASS_PANE.getDefaultState(), Blocks.GLASS_PANE.getDefaultState(), false);
        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 2, 2, 12, 3, 2, Blocks.GLASS_PANE.getDefaultState(), Blocks.GLASS_PANE.getDefaultState(), false);
        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 2, 10, 12, 3, 10, Blocks.GLASS_PANE.getDefaultState(), Blocks.GLASS_PANE.getDefaultState(), false);
        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 5, 0, 2, 8, 3, 2, wood, wood, false);
        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 6, 1, 2, 7, 2, 2, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
        ...
        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 1, 5, 1, 2, 7, upgradeStation.withProperty(BlockUpgradeStation.FACING, EnumFacing.EAST), upgradeStation.withProperty(BlockUpgradeStation.FACING, EnumFacing.WEST), false);
        this.fillWithBlocks(worldIn, structureBoundingBoxIn, 12, 1, 5, 12, 2, 7, upgradeStation.withProperty(BlockUpgradeStation.FACING, EnumFacing.WEST), upgradeStation.withProperty(BlockUpgradeStation.FACING, EnumFacing.EAST), false);
        this.setBlockState(worldIn, upgradeStationHolder.withProperty(BlockUpgradeStation.FACING, EnumFacing.EAST), 1, 1, 6, structureBoundingBoxIn);
        this.setBlockState(worldIn, upgradeStationHolder.withProperty(BlockUpgradeStation.FACING, EnumFacing.WEST), 12, 1, 6, structureBoundingBoxIn);
	...
	public static class CreationHandler implements IVillageCreationHandler{
		...
		public Village buildComponent(PieceWeight villagePiece, Start startPiece, List<StructureComponent> pieces,
			...
			StructureBoundingBox structureboundingbox = StructureBoundingBox.getComponentToAddBoundingBox(p1, p2, p3, 0, 0, 0, 13, 16, 10, facing);
	        return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(pieces, structureboundingbox) == null ? new MannCoBuilding(startPiece, p5, random, structureboundingbox, facing) : null;
		}
