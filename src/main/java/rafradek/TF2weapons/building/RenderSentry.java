...
public class RenderSentry extends RenderLiving<EntitySentry> {
	...
	public void doRender(EntitySentry living, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
	{
        ...
        if(living.isControlled()){
            ...
            RayTraceResult target=TF2weapons.pierce(living.worldObj, living, living.posX, living.posY+living.getEyeHeight(), living.posZ, look.xCoord+living.posX, look.yCoord+living.posY+living.getEyeHeight(), look.zCoord+living.posZ, false, 0.02f, false).get(0);
    		if(target!=null){
    			GlStateManager.pushMatrix();
    			
    			double xDist=target.hitVec.xCoord-(living.prevPosX+(living.posX-living.prevPosX)*p_76986_9_);
	    		double yDist=(target.hitVec.yCoord)-(living.prevPosY+(living.posY-living.prevPosY)*p_76986_9_+living.height/2);
